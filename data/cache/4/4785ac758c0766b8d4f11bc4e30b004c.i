...
<li>SerialManager 实现</li>
<li>GpioManager.path</li>
</ol>

<h2>调用关系</h2>

<ol>
<li>ContexImpl.java, SystemServer.java 注册到系统服务</li>
<li>app 调用getSystemService获取GpioManager.java</li>
<li>GpioManager.java 通过IGpioManager.aidl 调用GpioService.java</li>
<li>GpioService.java 调用通过AndroidRuntime.cpp onload.cpp注册的JNI com_android_server_GpioManager.cpp</li>
</ol>

<h2>实现步骤</h2>

<h3>实现Manager 文件,可通过getSystemServer获取Manager</h3>

<p>frameworks/base/core/java/android/os/GpioManager.java
frameworks/base/core/java/android/os/IGpioManager.aidl
frameworks/base/Android.mk</p>

<p>编译aidl</p>

<pre><code class="cpp">--- a/frameworks/base/Android.mk
...
<p>frameworks/base/services/core/jni/com_android_server_GpioManager.cpp
...
frameworks/base/services/core/jni/onload.cpp</p>

<pre><code class="cpp">--- a/frameworks/base/core/jni/Android.mk
...
<pre><code class="cpp">--- a/frameworks/base/core/jni/AndroidRuntime.cpp
...
<pre><code class="cpp">--- a/frameworks/base/services/core/jni/Android.mk
...
<pre><code class="cpp">--- a/frameworks/base/services/core/jni/onload.cpp
...
<pre><code class="cpp">--- a/frameworks/base/services/java/com/android/server/SystemServer.java
...
<h3>绑定Gpio manager 和服务</h3>

<p>frameworks/base/core/java/android/content/Context.java
frameworks/base/core/java/android/app/ContextImpl.java</p>

<pre><code class="cpp">--- a/frameworks/base/core/java/android/content/Context.java
...
<pre><code class="cpp">--- a/frameworks/base/core/java/android/app/ContextImpl.java
...
<p>如不能编译参考笔记“不能导入编译SDK新增class/api”</p>

<pre><code class="cpp">import android.os.GpioManager;
...
<pre><code class="cpp">import android.os.Gpio;
